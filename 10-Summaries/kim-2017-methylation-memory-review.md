...
- Foundational background for [[10-Summaries/hunt-2022-sctem-seq]] (TE methylation as bulk surrogate), [[10-Summaries/bai-2024-simple-seq]] (SIMPLE-seq joint 5mC/5hmC), and [[10-Summaries/shen-2026-splicool-seq]] (SpliCOOL-seq).
- Extends the methylation/lineage memory framing from [[10-Summaries/smith-2013-methylation-development]] (Smith/Meissner 2013) and intersects with [[10-Summaries/fu-2025-longread-methylation]] (long-read methylation).
