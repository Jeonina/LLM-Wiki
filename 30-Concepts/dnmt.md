---
type: concept
title: DNMT (DNA methyltransferases)
aliases: [DNA methyltransferase, DNMT1, DNMT3A, DNMT3B]
tags: [epigenetics, methylation, enzymes]
created: 2026-05-11
updated: 2026-05-11
---
...
- DNMT3A R882H is the most common DNMT3A mutation in AML.
- DNMT3L is a regulatory paralog without catalytic activity.

## Contested points

- DNMT3A vs DNMT3B specificity in different developmental contexts.

## Examples

- DNMT3A R882H clonal-hematopoiesis-driving mutation.
- Decitabine treatment of MDS — pharmacologic DNMT inhibition.
