...
- Uses [[10-Summaries/cistopic-cis-regulatory-topic-modeling-on-single-cell-atac-seq-data]] (cisTopic) for clustering and ArchR for analysis.
- Provides cell-number practical floor for designs guided by frameworks like [[10-Summaries/episcanpy-integrated-single-cell-epigenomic-analysis]] (EpiScanpy) and [[10-Summaries/comprehensive-analysis-of-single-cell-atac-seq-data-with-snapatac]] (SnapATAC).
