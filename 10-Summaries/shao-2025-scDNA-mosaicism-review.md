...
- **PTA's mechanism** — exonuclease-resistant terminators that produce short amplicons, biasing Φ29 toward priming on the native template — is the key innovation that elevated coverage from MDA's ~70–75% to PTA's ~95% while preserving allelic balance. This is *why* PTA dominates current scDNA-seq workflows including [[10-Summaries/swanson-2025-daf-seq|scDAF-seq]].
