...
- **Complementary to** [[10-Summaries/baysoy-2023-multiomics-landscape]] — same year, parallel reviews of single-cell multi-omics with different organizing principles (Katy: chemistry-axis; Alev: modality-axis).
- **Method-level reference for** [[10-Summaries/izzo-2024-got-cha]] (GoT–ChA + DOGMA), [[10-Summaries/nam-2019-got]] (GoT), [[10-Summaries/swanson-2025-daf-seq]] (DAF-seq).
