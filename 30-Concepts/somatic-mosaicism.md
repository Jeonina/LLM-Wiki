...
- The clinical actionable threshold (mosaic VAF) at which treatment decisions change — still empirical ([[10-Summaries/forsberg-2017-mosaicism-review]]).
...
- Clonal hematopoiesis: JAK2V617F detectable in 1–10% of blood at PCH stage decades before MPN ([[10-Summaries/izzo-2024-got-cha]]).
- CHILD syndrome midline-demarcated phenotype as direct evidence of first-mitosis mosaic mutation ([[10-Summaries/forsberg-2017-mosaicism-review]]).
- **Fetal-brain progenitors carry 200–400 mosaic SNVs/cell** at 15–21 weeks postconception, with mutation rate jumping ~3 orders of magnitude from pre-gastrulation to neurogenesis and mutation spectrum shifting from CpG-deamination to oxidative damage ([[10-Summaries/bae-2017-pregastrulation-mutations]]).
...
- **Chromosome 16 trisomy 13-fold enriched in mouse brain** (syntenic with human chr21), cell-type-specifically concentrated in oligodendrocyte precursor cells, Pons neurons, and pericytes ([[10-Summaries/mukamel-2025-aneuploidy-brain]]).
...
- **SNV + chromatin accessibility** in one cell: [[got-cha]] ([[10-Summaries/izzo-2024-got-cha|Franco 2024]]) — the GoT–ChA assay co-captures targeted genomic mutations and accessibility. Applied to clonal-hematopoiesis JAK2/CALR but not to broader mosaicism contexts.
- **DNA sequence + chromatin state on the same fiber**: [[daf-seq]] ([[10-Summaries/swanson-2025-daf-seq|Elliott 2025]]) — single-cell single-molecule deamination footprinting. The low-VAF CC>TT CTCF-ablating variant in COLO829 is the prototype mosaic-mutation + epigenetic-state direct observation.
...
- **Mutation + accessibility + RNA in one cell** (closes the gap): [[10-Summaries/kriz-2025-duplex-multiome|Duplex-Multiome]] (Kriz 2025) — duplex consensus sequencing integrated into 10x Multiome.
