...
type: concept
title: CALR mutation
aliases: [CALR, calreticulin mutation]
tags: [hematology, MPN, driver-mutation]
created: 2026-05-07
updated: 2026-05-07
---
...
> Recurrent somatic mutation in calreticulin (CALR), one of the three canonical drivers of [[myeloproliferative-neoplasm]] (along with [[jak2-v617f]] and MPL); activates MPL signaling and induces a cell-identity-dependent transcriptional response in hematopoietic progenitors.
...
- In **MF (advanced disease)**: TGFB1 upregulation in MkPs, proposed to drive marrow fibrosis.

This is the canonical example used throughout the wiki of "same mutation, different cell, different transcriptional output."

## Variants and refinements

- **Type 1** — 52-bp deletion; more strongly associated with myelofibrosis progression.
- **Type 2** — 5-bp insertion; more associated with essential thrombocythemia.
- Distinct from [[jak2-v617f]] in its mechanism (direct MPL binding vs constitutive kinase activation) and its consequence (UPR activation due to misfolded chaperone vs cytokine-independent JAK-STAT).
...
- [[jak2-v617f]] — sister driver mutation with different mechanism; both converge on JAK-STAT activation downstream.
