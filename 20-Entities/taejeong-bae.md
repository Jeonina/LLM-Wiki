---
type: entity
title: Taejeong Bae (TJ Bae)
aliases: [Bae, Taejeong Bae, TJ Bae, T Bae]
tags: [researcher, neuro-mosaicism, BSMN, foundational, wiki-maintainer-PI, korea-university]
created: 2026-05-12
updated: 2026-05-12
---
...
- **Postdoc / Research Scientist**: Mayo Clinic, Abyzov lab (Department of Health Sciences Research, now Quantitative Health Sciences) — period covering Bae 2018 + Bae 2022.
- **Now**: PI of the Bae Lab at Korea University (baelab.org).
- Long-standing collaboration with Alexej Abyzov (Mayo) and Flora Vaccarino (Yale Child Study Center). Member of the BSMN consortium.

## Research focus

- Computational mosaicism: variant calling from bulk and single-cell data, lineage reconstruction, BSMN pipeline development ([github.com/abyzovlab/bsmn-pipeline](https://github.com/abyzovlab/bsmn-pipeline)), cancer-signature cross-mapping for mosaic variants.
- Mosaicism in human brain development, aging, and neuropsychiatric disease.

## Wiki maintainer affiliation

The wiki user (Jeonina) is a student in TJ Bae's lab. References to Bae 2018 / Bae 2022 within this wiki are factual citations; the wiki's primary content (concept pages, summaries, synthesis notes) maintains a neutral field-wide voice rather than a lab-centric voice. This entity page exists for navigability and to document the researcher's career trajectory, not to frame the review.

## Related

- [[20-Entities/alexej-abyzov]] — senior author / PI on both Bae papers.
- [[20-Entities/flora-vaccarino]] — co-senior author on both papers.
- [[20-Entities/christopher-walsh]] — BSMN consortium co-leader; collaborator on Bae 2022.
- [[20-Entities/peter-park]] — BSMN co-leader.
- [[20-Entities/smaht-network]] — BSMN's successor consortium.
- [[40-Topics/somatic-mosaicism]] — the field these papers anchor.
