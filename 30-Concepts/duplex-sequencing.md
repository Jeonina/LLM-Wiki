...
Single-strand errors are filtered ([[10-Summaries/kennedy-2014-duplex-protocol]]). Single-strand DNA damage — of which a typical cell experiences ~70,000 lesions per day — is filtered ([[10-Summaries/diane-2025-naturereviewsgenetics]]). The error floor approaches the probability of the polymerase making the *exact same* error on both strands of the same molecule (≤10⁻⁸) ([[10-Summaries/schmitt-2012-pnas]]).
...
- **Tn5-based** — [[meta-cs]] is the only single-cell-compatible variant; Tn5 inserts adapters with orientation distinguishing the two strands ([[10-Summaries/diane-2025-naturereviewsgenetics]]).
...
- **Circularized sequencing** — HiDEF-seq (PacBio HiFi, error rate ~7 × 10⁻¹⁶) ([[10-Summaries/diane-2025-naturereviewsgenetics]]), SMM-seq (Illumina rolling-circle) ([[10-Summaries/diane-2025-naturereviewsgenetics]]).

## Why it matters

Duplex sequencing redefines the **fidelity** floor of variant detection ([[10-Summaries/gilad-2021-annualreviewofgenomicsandhumangenetics]]). Without it, the false-positive rate at low VAFs is dominated by ssDNA damage; with it, true variants at <1% VAF become detectable ([[10-Summaries/kennedy-2014-duplex-protocol]]; [[10-Summaries/schmitt-2012-pnas]]).

Most duplex methods sequence **bulk DNA** at single-molecule resolution — they capture the full mutational landscape but cannot assign variants to specific cells ([[10-Summaries/diane-2025-naturereviewsgenetics]]). [[meta-cs]] is the exception and the bridge to per-cell duplex resolution ([[10-Summaries/diane-2025-naturereviewsgenetics]]). **Duplex-Multiome** further integrates duplex consensus into the 10x Multiome platform, achieving per-nucleus point-mutation + scATAC + scRNA ([[10-Summaries/andrea-2025-biorxiv]]).
...
- Trade-off: duplex sequencing requires twice the read depth per molecule and complex library prep — cost per variant detected is high ([[10-Summaries/diane-2025-naturereviewsgenetics]]).
...
- NanoSeq detection of somatic SNVs across normal human tissues at error rate <5 × 10⁻⁹ ([[10-Summaries/abascal-2021-nanoseq]]; [[10-Summaries/diane-2025-naturereviewsgenetics]]).
- HiDEF-seq on PacBio reaching ~7 × 10⁻¹⁶ error rate from concatenated Watson-Crick reads ([[10-Summaries/diane-2025-naturereviewsgenetics]]).
- CODEC: ligated-quadruplex single-read duplex resolution ([[10-Summaries/bae-2023-codec]]).
- [[meta-cs]] applied to single cells — bridging duplex and scDNA-seq ([[10-Summaries/diane-2025-naturereviewsgenetics]]).
- Duplex-Multiome: 51,400 nuclei from postmortem human brain with point mutations + chromatin + RNA per cell ([[10-Summaries/andrea-2025-biorxiv]]).
