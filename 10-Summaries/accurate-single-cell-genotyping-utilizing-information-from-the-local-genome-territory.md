...
- Pre-PTA paper; the PTA era of scWGA ([[10-Summaries/diane-2025-naturereviewsgenetics]], [[10-Summaries/a-comprehensive-view-of-somatic-mosaicism-by-single-cell-dna-analysis]]) somewhat reduces but does not eliminate the need for SCOUT-style callers — amplification bias still exists.
- Connects to [[30-Concepts/somatic-mosaicism]] tooling stack — alongside [[10-Summaries/benchmarking-of-duplex-sequencing-approaches-to-reveal-somatic-mutation-landscapes]] which validates DS at the bulk level, SCOUT validates calls at the cell level.
